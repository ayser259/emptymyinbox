...
struct InsightGenerationResult: Codable {
    let summary: String
...
actor OpenAIService {
    ...
    func classifyBriefingItem(subject: String, snippet: String, sender: String) async throws -> BriefingItemType {
    ...
    func summarizeNewsletterStories(
        subject: String,
        snippet: String,
        sender: String,
        body: String?,
