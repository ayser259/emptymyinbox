...
1. Add **iCloud → CloudKit** in Xcode for both targets and create container `iCloud.aysersHobbies.ProjectJade` (or change `AppCloudKitConfiguration.containerIdentifier`).
